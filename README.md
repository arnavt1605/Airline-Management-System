...
<ol>
  <li>Navigate to root directory of the project in the terminal</li>
  <li>Type "python -m venv <name_of_environment>" </li>
...
<ol>
  ...
  <li>If you have an virtual environment, activate it by typing "<virtual_env_name>\Scripts\activate" in the terminal</li>
  <li>Run the following command: "python -m flask run"</li>
  <li>Open the URL generated in your browser by clicking on it</li>
  <li>Once done, press Ctrl+C in your terminal to stop the command</li>
  <li>Deactivate the virtual environment by typing "deactivate" in the terminal</li>
</ol>
